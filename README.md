...
This is my final project for the EECE558 Embedded Systems Design course at Binghamton University. It is a bare metal Snake game in embedded C using the Raspberry Pi Pico 2 and two MAX7219 LED matrix modules.
...
## Credits
Much credit goes to Dr. Summerville for providing the course environment and writing basic drivers for DMA, Timer0, SysTick, and Watchdog.
